...
def join_path(args):
    ...
    args.eval_out_dir = os.path.join(args.exp_root, args.eval_out_dir)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--cam_eval_use_crf", default=False)
    ...
    parser.add_argument("--eval_out_dir", default="result/eval", type=str)
