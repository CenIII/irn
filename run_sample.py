...
if __name__ == '__main__':
    ...
    parser.add_argument("--cam_eval_thres", default=0.05, type=float)
    ...
    parser.add_argument("--seg_network", default="net.deeplabv2", type=str)
    ...
    parser.add_argument("--unary_fg_thres", default=0.15, type=float)
    parser.add_argument("--unary_bg_thres", default=0.15, type=float)
    ...
    parser.add_argument("--irn_weights_name", default="sess/res50_clsbd", type=str)
    ...
    parser.add_argument("--make_unary_pass", default=True)
    ...
    if args.make_unary_pass is True:
        import step.make_unary

        timer = pyutils.Timer('step.make_unary:')
        step.make_unary.run(args)
